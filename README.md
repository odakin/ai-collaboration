...
- `scripts/` — `verification-campaign-report.py`, `ledger-commit-cadence-gate.py`, `check-edit-intent.py`, `check-sign-anchors.py` (sign-carrying printed claims: external-anchor registry, end-to-end global-flip foils, fleet-invariance scan, un-carried convention deferrals), `make-review-sandbox.py`, `review-markup-clean.py`, `strip-tex-comments.py`, `init-verification-repo.py`, `gpt_measurements.py`, `state_discrimination.py`, `hpd-credible-level.py`, `svg-contour-extract.py`, `floquet-monodromy.py`, `nstar-fixed-point.py`, `expanding-mode-growth.py`, `dilaton-spectator-growth.py`, `one_loop_pole.py` (exact 1/ε poles of one-loop integrals from printed Feynman rules; sympy), `dirac_algebra.py` (mostly-plus Dirac conventions, every identity asserted), `heat_kernel_a4.py` (Seeley–DeWitt a4 by invariant fitting, with textbook anchors), `covariant_moment_algebra.py` (full-line ladder and finite-window endpoints), `povm_moment_variance.py` (measured versus first-operator variance), `unbounded_operator_domains.py` (domain and weak-identity counterexamples) (each has `--selftest`)
